...
def fasta_folder_to_dict(folder_path):
    ...
    """
    new_dict = dict()
    validSequenceChars= re.compile(r'[^AGCT]')
        ...
        with open(folder_path+'/'+file, 'r') as infile:
            ...
            for seq in seqs[1:]:
                try:
                    ...
                    if header in new_dict:
                        if new_dict[header]==sequence:
                    ...
                    if sequence=="":
                        ...
                        continue
                    if not bool(validSequenceChars.search(sequence)):

                        new_dict[header] = sequence
                    else:
...
fasta_folder_to_dict("/Users/priyankadeshmukh/Downloads/test_files")
